...
string jsonMenus = new System.Web.Script.Serialization.JavaScriptSerializer().Serialize(ControlUsuarios.Entity.Controller.MenusController.getMenus(menusId)); %>
menus = <%= jsonMenus %> 
console.log(menus);
cargarDatos(menus);
</script>
